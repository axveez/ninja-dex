...
import logo from '../assets/Ninja_Logo_img.png';
...
import { getTradePageUrl,getChartPageUrl } from '../utils/markets';
...
export default function TopBar() {
  ...
  const chartPageUrl = location.pathname.startsWith('/charts/')
    ? location.pathname
    : getChartPageUrl();
